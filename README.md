...
The following command line will compile, generate the test files and execute the tests.
...
## C/C++
The following commands creates the binary in the `target` directory.
Note that above Java code must have been built once before the following commands can be executed.
